...
#SBATCH -o /beamlines/bl09/controls/cluster/logs/bl09_txrm2nexus_%N_%j.out
#SBATCH -e /beamlines/bl09/controls/cluster/logs/bl09_txrm2nexus_%N_%j.err
#SBATCH --tmp=8G
################################################################################
...
WORKDIR="/beegfs/scratch/bl09/bl09_txrm2nexus_${SLURM_JOBID}"
mkdir -p $WORKDIR
