...
### Input parameters #######################################################
# 1: Input: HDF5 File containing the normalized projections stack
...
#SBATCH -o /beamlines/bl09/controls/cluster/logs/bl09_norm2recons_%N_%j.out
#SBATCH -e /beamlines/bl09/controls/cluster/logs/bl09_norm2recons_%N_%j.err
#SBATCH --tmp=16G
#SBATCH -N 1
#SBATCH -c 32
################################################################################
...
WORKDIR="/beegfs/scratch/bl09/bl09_norm2recons_${SLURM_JOBID}"
mkdir -p $WORKDIR
...
### MAIN script ################################################################
cd ${WORKDIR}
echo "Running norm2recons Workflow"
echo "---------------------------"

# Align normalized hdf5 projection stack
ctalign ${SOURCEDATAFILE}
aligned_hdf5="${SOURCEDATAFILE%.hdf5}_ali.hdf5"
